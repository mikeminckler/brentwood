...
trait PhotosTrait
{
    ...
    public function savePhotos($input, $duplicate = null)
    {
        if (Arr::get($input, 'photos')) {
            foreach (Arr::get($input, 'photos') as $photo_data) {
                $photo = (new Photo)->savePhoto($photo_data, Arr::get($photo_data, 'id'), $this, $duplicate);
            }
        }
    }

    public function saveSinglePhoto($input, $duplicate = null)
    {
        if (Arr::get($input, 'photos')) {
            ...
            return (new Photo)->savePhoto($photo_data, $photo_id, $this, $duplicate);
        }
    }
}
