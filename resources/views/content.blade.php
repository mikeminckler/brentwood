    @foreach ($content_elements as $index => $content_element)
        ...
        @endif
            ...
            <div class="box-border 
                ...
                {{ isset($last_tags) ? ($content_element->tags->intersect($last_tags)->count() ? '' : '-mt-16 md:-mt-24 pt-16 md:pt-24 first:pt-12 md:first:pt-24') : '-mt-16 md:-mt-24 pt-24 md:pt-24 first:pt-12 md:first:pt-24' }}
                "
