<template>
    ...
    <div class="pl-2 border-l-2 border-gray-300" :class="[page.unlisted ? 'bg-gray-200' : '', !page.published_version_id ? 'text-gray-500 italic' : '']">
        <div class="flex hover:bg-white border-b border-gray-300">
            ...
            <div class="" v-if="showContentElements" @click="displayContentElements = !displayContentElements"><i class="fas fa-file-alt"></i></div>
        </div>
...
<script>
    export default {
        props: ['page', 'emitEvent', 'showContentElements', 'expanded'],
